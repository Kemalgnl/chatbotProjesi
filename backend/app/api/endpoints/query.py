...
import shutil
from app.services.rag_service import initialize_vector_store, get_vector_store, LLM_MODEL
...
async def ask_question(question: str = Form(...), txt_file: UploadFile | None = File(None)):
    ...
    try:
        ...
        print(f"TXT dosyası okunamadı: {e}")
        relevant_chunks = []
    ...
    """
    #print(prompt)
    #print("Önceki soru:", oldQuestion)
    #print("Yeni soru:", question)
